...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '注塑工艺参数表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of injection_param
-- ----------------------------
INSERT INTO `injection_param` VALUES (1, 'PLAN-20250701-001', '1', 'INJ-002', 92.5, 45.2, 8.5, 15.2, 65, 205);
INSERT INTO `injection_param` VALUES (2, 'PLAN-20250701-002', '3', 'INJ-001', 85, 42.8, 7.8, 14.5, 62, 200);
INSERT INTO `injection_param` VALUES (3, 'PLAN-20250625-001', '5', 'INJ-002', 88.3, 43.5, 8, 14.8, 63.5, 202);
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '印刷图案信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of print_pattern
-- ----------------------------
INSERT INTO `print_pattern` VALUES (1, 'PLAN-20250701-001', '2', 'PRT-102', 'PAT-001', '几何星空', 'B', '/uploads/patterns/77be174d-1be7-4098-90e5-66fc6a721cd9_R-C (1).jpg', 1200, 3.2);
INSERT INTO `print_pattern` VALUES (2, 'PLAN-20250701-002', '4', 'PRT-103', 'PAT-002', '大理石纹', 'A', '/uploads/patterns/ddd5cfe4-b417-4586-a995-2dc82d6dd103_R-C.jpg', 1100, 2.8);
INSERT INTO `print_pattern` VALUES (3, 'PLAN-20250625-001', '6', 'PRT-102', 'PAT-003', '中国风祥云', 'B', '/uploads/patterns/c214d639-b8e7-43f5-9aec-98cdfeb8d542_2126.png_860.png', 1300, 3.5);
